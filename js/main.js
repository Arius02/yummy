...
function valid(){
  ...
  $("#phone").keyup(function () {
    ...
    if (phoneRegex.test(phoneVal)) {
      ...
      $("#phone").removeClass("unvalid")
      $(this).siblings(".fa-xmark").addClass("d-none")
      $(this).siblings(".fa-check").removeClass("d-none")
      $(this).parent().siblings().addClass("d-none")
      phoneFlag = true
    } else if (phoneVal == "") {
      $("#phone").addClass("unvalid")
  ...
  $("#age").keyup(function () {
    ...
    if (ageRegex.test(ageVal)) {
      $("#age").addClass("valid")
      $("#age").removeClass("unvalid")
      $(this).siblings(".fa-xmark").addClass("d-none")
      $(this).siblings(".fa-check").removeClass("d-none")
      $(this).parent().siblings().addClass("d-none")
      ageFlag = true
    } else if (ageVal == "") {
      $("#age").addClass("unvalid")
  ...
  $("#pass").keyup(function () {
    ...
    if (passRegex.test(passVal)) {
      $("#pass").addClass("valid")
      $("#pass").removeClass("unvalid")
      $(this).siblings(".fa-xmark").addClass("d-none")
      $(this).siblings(".fa-check").removeClass("d-none")
      $(this).parent().siblings().addClass("d-none")
      passFlag = true
    } else if (passVal == "") {
      $("#pass").addClass("unvalid")
  ...
  $("#rePass").keyup(function () {
    ...
    if (rePassVal == passVal) {
      ...
      $("#rePass").removeClass("unvalid")
      $(this).siblings(".fa-xmark").addClass("d-none")
      $(this).siblings(".fa-check").removeClass("d-none")
      $(this).parent().siblings().addClass("d-none")
      rePassFlag = true
    } else if (rePassVal == "") {
      $("#rePass").addClass("unvalid")
